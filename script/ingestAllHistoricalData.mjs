...
const MONTHS_2024 = [
  {
    ...
    period: '2024-04',
    sheetId: '14rvOhScbEekNLV6Nmn__bQVhbxP7X0oqhSalz-BTl1s',
  },
  {
    key: '2024_05',
    monthName: 'May 2024',
    period: '2024-05',
    sheetId: '1xMVOs5yMazAG-NA3b4y7lz3aGPDZqzi7i9T-pzNsHv0',
  },
  {
    key: '2024_06',
    monthName: 'June 2024',
    period: '2024-06',
    sheetId: '1RV5syYkJjQZ14QoR5vynxgfbikRwxlZvMNJeEbLltVU',
  },
  {
    key: '2024_07',
    monthName: 'July 2024',
    period: '2024-07',
    sheetId: '1wFMBKMD4KESh47rIOa88OkY4EOd3GSeED6ib04NrdtQ',
  },
  {
    key: '2024_08',
    monthName: 'Aug 2024',
    period: '2024-08',
    sheetId: '1IXvKjF5Nps0gAVEM-dt1iwJs64tEvxDPOoCgYOBQ4lw',
  },
  {
    key: '2024_09',
    monthName: 'Sep 2024',
    period: '2024-09',
    sheetId: '1gJFn8NDkY78NKy41Oec8f6vGAIkaCrJ9z8bIkGQr6pQ',
  },
  {
    key: '2024_10',
    monthName: 'Oct 2024',
    period: '2024-10',
    sheetId: '1t55BvCeXlSqgbI5dpvDqrJSIA8gVl5ENgo56TAZDSYI',
  },
  {
    key: '2024_11',
    monthName: 'Nov 2024',
    period: '2024-11',
    sheetId: '1rcm6QVqS9kW0113_zpyn7XZGfOwX6n-wVYFvZN4cru0',
  },
  {
    key: '2024_12',
    monthName: 'Dec 2024',
    period: '2024-12',
    sheetId: '1_beZmyLuX9GrED7KdEOm4AyNeKTAnyACN51ZqcgzYMs',
  },
];
...
export async function runIngestion() {
  console.log(
    '🚀 Starting Complete Multi-Year (2024, 2025, 2026) Ingestion Pipeline...\n',
  );
  ...
  // =========================================================================
  console.log(
    '📋 Extracting Starting 2024-03-31 Baseline Customer Opening Dues...',
  );
  const clApril2024 =
    dump2024.creditLists['Customer Credit List-30-april']?.data?.Sheet1 || [];
  ...
  console.log(
    `✅ Extracted 2024-03-31 Baseline Opening Due: ₹${total2024OpeningDue.toLocaleString()} across ${count2024OpeningCust} accounts`,
  );
    ...
    if (purchaseRows.length > 1) {
      for (let i = 1; i < purchaseRows.length; i++) {
        ...
        if (
          ...
          rawVendor.toLowerCase().includes('item') ||
  ...
  console.log(
    '💳 Extracting 2024 Customer Payments from Monthly Credit Lists...',
  );
  const payments2024 = [];
  const creditPairs2024 = [
    {
      period: '2024-04',
      key: '2024_04',
      curr: 'Customer Credit List-30-april',
      prev: null,
    },
    {
      period: '2024-05',
      key: '2024_05',
      curr: 'Customer Credit List-May-31',
      prev: 'Customer Credit List-30-april',
    },
    {
      period: '2024-06',
      key: '2024_06',
      curr: 'Customer Credit List-20240630',
      prev: 'Customer Credit List-May-31',
    },
    {
      period: '2024-07',
      key: '2024_07',
      curr: 'Customer Credit List-20240731',
      prev: 'Customer Credit List-20240630',
    },
    {
      period: '2024-08',
      key: '2024_08',
      curr: 'Customer Credit List-20240831',
      prev: 'Customer Credit List-20240731',
    },
    {
      period: '2024-09',
      key: '2024_09',
      curr: 'Customer Credit List-20240930',
      prev: 'Customer Credit List-20240831',
    },
    {
      period: '2024-10',
      key: '2024_10',
      curr: 'Customer Credit List-20241030',
      prev: 'Customer Credit List-20240930',
    },
    {
      period: '2024-11',
      key: '2024_11',
      curr: 'Customer Credit List-20241130',
      prev: 'Customer Credit List-20241030',
    },
    {
      period: '2024-12',
      key: '2024_12',
      curr: 'Customer Credit List-20241231',
      prev: 'Customer Credit List-20241130',
    },
  ];

  for (const pair of creditPairs2024) {
    const currRows = dump2024.creditLists[pair.curr]?.data?.Sheet1 || [];
    const prevRows = pair.prev
      ? dump2024.creditLists[pair.prev]?.data?.Sheet1 || []
      : [];
  ...
  console.log(
    `✅ Extracted ${sales2024.length} Sales, ${purchases2024.length} Purchases, ${payments2024.length} Payments for 2024`,
  );
  ...
  // 2025 Payments
  console.log(
    '💳 Extracting 2025 Customer Payments from Monthly Credit Lists...',
  );
  const payments2025 = [];
  const creditPairs2025 = [
    ...
    },
    {
      period: '2025-12',
      key: '2025_12',
      curr: 'Customer Credit List-20251231',
      prev: 'Customer Credit List-20251130',
    },
  ];
  ...
  console.log(
    `✅ Extracted ${sales2025.length} Sales, ${purchases2025.length} Purchases, ${payments2025.length} Payments for 2025`,
  );
  ...
  console.log(
    `✅ Continuous Dynamic Outstanding (at end of Aug 2026): ₹${totalSystemFinalOutstanding.toLocaleString()} across ${allCustomers.length} accounts`,
  );
  ...
  console.log(
    `✅ Generated ${opening2024SalesRows.length} opening balance records for 2024-03-31`,
  );
  ...
  console.log(
    `  -> Updated customers.csv (${allCustomers.length} total customers)`,
  );
  ...
  console.log(
    `  -> Updated sales.csv (${allSalesCsvRows.length} total sales records)`,
  );
